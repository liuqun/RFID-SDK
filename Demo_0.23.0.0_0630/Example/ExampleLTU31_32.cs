    ...
    static class ExampleLTU31_32
    {
        static void Main()
        {
            ...
            if (clientConn.OpenSerial("COM6:115200", 3000, out status))
            {
                ...
                msgBaseInventoryEpc.CtesiusMode = 2;        // LTU31
        ...
        public static void OnEncapedTagEpcLog(EncapedLogBaseEpcInfo msg)
        {
            ...
            if (null != msg && 0 == msg.logBaseEpcInfo.Result) 
            {
                ...
                {
                    string sltu31_32 = ((double)msg.logBaseEpcInfo.CtesiusLTU31 / 100).ToString("F2");
                    Console.WriteLine(msg.reader + ":ant[" + msg.logBaseEpcInfo.AntId + "]" + msg.logBaseEpcInfo.Epc + "|" + sltu31_32 + " ℃");
                }
            }
        }
